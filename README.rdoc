...
Then restart Redmine. In project's setting in Modules include 'EasyAgile' or enable it globally for all projects from Administration area. It will be available under 'Easy Agile' tab.
...
=== Project team
{Mykhaylo Sorochan}[http://msorc.github.com] - software development<br>
